    ...
    return ( 
        <div className="EReg-container">
            ...
            <form className="fregister" onSubmit={handleSubmit}>
				...
				<input style={{height:"4vh",width:"40vh"}} value={number} onChange={(e) => setNum(e.target.value)} name="number" id="number" type="number" placeholder="Mobile Number"/><br/>
				<div className="form-group">
                            <label htmlFor="agreeTerms"><br/>
                                   <input type="checkbox"
                                          id="agreeTerms"
                                          checked={agreeTerms}
				...
				<button style={{backgroundColor:"rgb(216, 200, 249)",height:"5vh",width:"41vh",border:"green"}}  type="submit">Register</button>
			</form>
            <br/> <Link to='/Elogin'>Already have an account? Login here</Link>
            </div>
