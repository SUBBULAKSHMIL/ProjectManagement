	...
	return (
		<div className="Alog-container">
            ...
            <div className='Alog-left'>
				...
				<br/><br/><h2 style={{'fontSize':'30px'}} >Admin Log In</h2>
					...
					<Link to='/Asidebar'>
						<button type="submit" style={{height:"5vh",width:"41vh",backgroundColor:"powderblue",border:"green"}} className="Elog-button" onClick={() => { dispatch(login({ email }));navigate("/Asidebar") }} >Log In</button><br /><br />
					</Link>
					</div>
				</form>
				<Link to='/mregister'>New User? Register</Link>
			</div>
